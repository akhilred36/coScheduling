...
"""
            ...
            srun_command = f"time srun --exclusive -n {num_cpus} --distribution=block:block --cpu-bind=cores --mpibind=on,v env LD_PRELOAD=\"{mpip_path}\" MPIP=\"-f {mpip_profiles_dir}\" {exec_full_path}{args_str} > {output_log} 2>&1"
