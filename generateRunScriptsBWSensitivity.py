...
inhib_wait_times = [0, 10, 100, 1000, 10000]
...
for i in range(20):
    for msg_size in inhib_msg_sizes:
        for wait_time in inhib_wait_times:
            ...
            for j in range(20):
                slurm_file.write(f"srun --exclusive -n 2 --mem 30G --cpus-per-task 1 --ntasks-per-node 1 --nodes 2 --ntasks-per-socket 1 ./stream.exe -j -t 20 -m 8000000 >> ../../../../experiment_scripts_BWSensitivity/{dir_name}/output.log\n")
