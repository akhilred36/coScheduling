/*
  ...
  gengetopt -F schedgen_cmdline -i /users/aalasand/carc-scratch/workspace/LogGOPSim/src/Schedgen/schedgen_cmdline.ggo --output-dir /users/aalasand/carc-scratch/workspace/LogGOPSim/src/Schedgen 
