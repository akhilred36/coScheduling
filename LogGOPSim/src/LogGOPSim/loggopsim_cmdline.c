/*
  ...
  gengetopt -F loggopsim_cmdline -i /users/aalasand/carc-scratch/workspace/LogGOPSim/src/LogGOPSim/loggopsim_cmdline.ggo --output-dir /users/aalasand/carc-scratch/workspace/LogGOPSim/src/LogGOPSim 
